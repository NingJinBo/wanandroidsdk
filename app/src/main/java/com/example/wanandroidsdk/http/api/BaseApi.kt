...
class BaseApi {
    ...
    protected fun getHttpClient(tagName: String?): OkHttpClient.Builder {
        ...
        try {
            ...
            httpClientBuilder.connectTimeout(
                BaseApi.DEFAULT_TIMEOUT.toLong(),
                TimeUnit.MILLISECONDS
            )
            httpClientBuilder.writeTimeout(BaseApi.DEFAULT_TIMEOUT.toLong(), TimeUnit.MILLISECONDS)
            httpClientBuilder.readTimeout(BaseApi.DEFAULT_TIMEOUT.toLong(), TimeUnit.MILLISECONDS)
